...
*** TODO Reimplement Child and Client as subclasses to be able to manage attributes properly
** Sunday
*** TODO [#A] Statistics module
...
*** TODO Documentation
*** TODO Workers going on breaks
*** TODO [#A] Operators actually starting rides
*** TODO [#A] Multiple simulation iterations
*** TODO [#B] Fix table contents
*** TODO [#A] Crying
